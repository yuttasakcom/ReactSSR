...
var UserList = function (_React$Component) {
  ...
  _createClass(UserList, [{
    ...
    value: function componentWillMount() {
      this.props.dispatch((0, _actions.fetchUsers)());
    }
  }, {
    key: 'renderUsers',
...
exports.default = {
  loadData: loadData,
  component: (0, _reactRedux.connect)(mapStateToProps)(UserList)
};
...
var AdminsListPage = function (_Component) {
  ...
  _createClass(AdminsListPage, [{
    ...
    value: function componentDidMount() {
      this.props.dispatch((0, _actions.fetchAdmins)());
    }
  }, {
    key: 'renderAdmins',
...
exports.default = {
  component: (0, _reactRedux.connect)(mapStateToProps)((0, _requireAuth2.default)(AdminsListPage)),
  loadData: function loadData(_ref2) {
    var dispatch = _ref2.dispatch;
